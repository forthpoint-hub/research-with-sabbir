  ...
  return (
    <section className="container-page max-w-3xl py-10">
      <div className="flex items-center justify-between">
        <h1 className="font-serif text-2xl text-paper">Pages</h1>
        <Link
      ...
      <div className="mt-8">
        {loading ? (
          ...
          <p className="text-sm text-paper-dim">No custom pages yet.</p>
        ) : (
              ...
              <div key={item.id} className="flex items-center justify-between gap-4 py-4">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-paper-dim">
                    /{item.slug} &middot; {item.published ? "Published" : "Draft"}
                  </p>
                </div>
                <div className="flex shrink-0 gap-4 text-sm">
                  <Link href={`/admin/pages/${item.id}`} className="text-gold no-underline">
                    Edit
                  </Link>
